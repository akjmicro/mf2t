...
char *msg() { return (Msgbuff); }

msgleng() { return (Msgindex); }
...
void mfwrite(format, ntracks, division, fp) int format, ntracks, division;
FILE *fp;
{
  int i;
...
void mf_w_track_chunk(which_track, fp, wtrack) int which_track;
FILE *fp;
int (*wtrack)();
{
...
void mf_w_header_chunk(format, ntracks, division) int format, ntracks, division;
{
 ...
 */
int mf_w_midi_event(delta_time, type, chan, data,
                    size) unsigned long delta_time;
 ...
 */
int mf_w_meta_event(delta_time, type, data, size) unsigned long delta_time;
 ...
 */
int mf_w_sysex_event(delta_time, data, size) unsigned long delta_time;
unsigned char *data;
unsigned long size;
{
  int i;
...
void mf_w_tempo(delta_time, tempo) unsigned long delta_time;
unsigned long tempo;
{
  /* Write tempo */
...
unsigned long mf_sec2ticks(secs, division, tempo) int division;
unsigned int tempo;
float secs;
 ...
 */
void WriteVarLen(value) unsigned long value;
{
 ...
 *
 */
float mf_ticks2sec(ticks, division, tempo) int division;
unsigned int tempo;
unsigned long ticks;
{
 ...
 *
 */
void write32bit(data) unsigned long data;
{
